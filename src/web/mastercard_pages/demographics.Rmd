...
tract_vars <- acs_tract[, c("black", "hispanic", 'unempl', "med_inc_all", "med_inc_w", "med_inc_a", "med_inc_b", "med_inc_h", "med_inc_o")]
...
tract_tab %>% 
  ...
  stargazer::stargazer(type = "latex", 
                       digits = 2, 
                      # summary = F,
                       caption = "Summary Statistics of Demographic Indicators for Arlington County",
                       header = F,
               align = "c",
                       label =  "Source: American Community Survey 5-Year Data (2015-2019)")
```
...
## Maps  
### By Racial Demography  
```{r echo=FALSE}
acs <- read_rds("./data/working/acs_tract.Rds")
acs_tract = acs %>% drop_na(totalpop_trct, black, asian, hispanic, white, other_race)
...
leaflet(acs_tract) %>% #create leaflet object
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$asian), values = ~asian, group = "Asian Population", title = "Asian<br>Population", position = "topleft") %>%
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$white), values = ~white, group = "White Population", title = "White<br>Population", position = "topleft") %>%
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$other_race), values = ~other_race, group = "Other Race Population", title = "Other Race<br>Population", position = "topleft") %>%
...
```{r}
acs <- read_rds("./data/working/acs_tract.Rds")
acs_tract = acs %>% drop_na(med_inc_all)
...
leaflet(acs_tract) %>% #create leaflet object
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_all), values = ~med_inc_all, group = "Median Income: All", title = "Median<br>Income", position = "topleft") %>%
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_b), values = ~med_inc_b, group = "Median Income: African-American", title = "Median<br>Income", position = "topleft") %>%
  ...
  addPolygons(data = acs_tract, color = "#444444", weight = 1, smoothFactor = 0.5,
              ...
              label = ~paste0("The median income of an Asian household in ", str_replace(`NAME.y`,", Arlington County, Virginia", ""), " is $", round(`med_inc_a`,2), "."))  %>%
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_a), values = ~med_inc_a, group = "Median Income: Asian", title = "Median<br>Income", position = "topleft") %>%
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_h), values = ~med_inc_h, group = "Median Income: Hispanic", title = "Median<br>Income", position = "topleft") %>%
  ...
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_w), values = ~med_inc_w, group = "Median Income: White", title = "Median<br>Income", position = "topleft") %>%
  ...
  addPolygons(data = acs_tract, color = "#444444", weight = 1, smoothFactor = 0.5,
              ...
              label = ~paste0("The median income of other race household in\n", str_replace(`NAME.y`,", Arlington County, Virginia", ""), " is $", round(`med_inc_o`,2), "%.")) %>% 
  addLegend(data = acs_tract, pal = colorNumeric("PuOr", acs_tract$med_inc_o), values = ~med_inc_o, group = "Median Income: Other Race", title = "Medianr<br>Income", position = "topleft") %>%
